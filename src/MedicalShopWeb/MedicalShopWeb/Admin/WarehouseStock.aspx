<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="WarehouseStock.aspx.cs" Inherits="MedicalShopWeb.Admin.WarehouseStock" %>
...
<div class="form">
    ...
    <div class="panel-body">
     ...
     <div class="row form-group">
        ...
        <div class="col-sm-8">
             <asp:TextBox ID="txtStock" runat="server" class="form-control" 
                 placeholder="Stock" readonly ontextchanged="txtStock_TextChanged"></asp:TextBox>
            </div>
     </div> 
     <!--End Of Third Row-->
     ...
     <div class="panel-footer" align="left">
      ...
      <div class="panel-body">
        <div class="row">
        <asp:GridView ID="grvWarehouseStock" runat="server" AutoGenerateColumns="false" class="table" HeaderStyle-BackColor="#4596f1"
         HeaderStyle-ForeColor="White"  BorderColor="White"  HeaderStyle-BorderColor="#4596f1" AllowPaging="true" ><%--onpageindexchanging="grvWarehouseStock_PageIndexChanging"--%>
