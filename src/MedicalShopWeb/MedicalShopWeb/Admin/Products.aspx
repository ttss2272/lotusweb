<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="MedicalShopWeb.Products" %>
        ...
        <div class="form-group">
            <div class="panel panel-default">
                <div class="panel-header" align="left">
                    <div class="col-xs-12">
                        <h3>
                            <asp:Label ID="lblPageHeading" runat="server" Text="Products Details" class="control-label label label-info"></asp:Label></h3>
                    </div>
                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="lblProductType" runat="server" Text="Product Type" class="control-label">
                                            <asp:RequiredFieldValidator ID="ReqValProductType" runat="server" ErrorMessage="*"
                                                Display="Dynamic" Font-Bold="True" ForeColor="Red" ControlToValidate="ddproductType"
                                                InitialValue="-1" SetFocusOnError="True" ToolTip="Please Select Product Type"
                                                ValidationGroup="SaveProductDetails"></asp:RequiredFieldValidator>
                                        </asp:Label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="lblDOB" runat="server" Text="Product Name" class="control-label">
                                            <asp:RequiredFieldValidator ID="ReqValidPrductName" runat="server" ErrorMessage="*"
                                                Display="Dynamic" Font-Bold="True" ForeColor="Red" ControlToValidate="txtProductName"
                                                SetFocusOnError="True" ToolTip="Please Enter Product Name" ValidationGroup="SaveProductDetails"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegProductName" runat="server" ErrorMessage="*"
                                                ValidationExpression="[a-zA-Z ]*$" ControlToValidate="txtProductName" Display="Dynamic"
                                                Font-Bold="True" ForeColor="Red" SetFocusOnError="True" ToolTip="Enter Only Characters"
                                                ValidationGroup="SaveProductDetails"></asp:RegularExpressionValidator>
                                        </asp:Label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="lblCode" runat="server" Text="Code" class="control-label">
                                            <asp:RequiredFieldValidator ID="ReqCode" runat="server" ErrorMessage="*" Display="Dynamic"
                                                Font-Bold="True" ForeColor="Red" ControlToValidate="txtCode" SetFocusOnError="True"
                                                ToolTip="Please Enter Code Number" ValidationGroup="SaveProductDetails"></asp:RequiredFieldValidator>
                                        </asp:Label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtCode" runat="server" class="form-control" placeholder="Enter Code"
                                            required />
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-sm-8">
            <asp:TextBox ID="txtbatch" runat="server" class="form-control" placeholder="Enter Batch" required />
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="lblAddress" runat="server" Text="Purchase Price" class="control-label">
                                            <asp:RequiredFieldValidator ID="ReqValPurchasePrice" runat="server" ErrorMessage="*"
                                                Display="Dynamic" Font-Bold="True" ForeColor="Red" ControlToValidate="txtPurchasePrice"
                                                InitialValue="-1" SetFocusOnError="True" ToolTip="Please Enter Pruchase Price"
                                                ValidationGroup="SaveProductDetails"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*"
                                                ValidationExpression="[0-9]*$" ControlToValidate="txtPurchasePrice" Display="Dynamic"
                                                Font-Bold="True" ForeColor="Red" SetFocusOnError="True" ToolTip="Enter Only Numbers"
                                                ValidationGroup="SaveProductDetails"></asp:RegularExpressionValidator>
                                        </asp:Label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtPurchasePrice" runat="server" class="form-control" placeholder="Enter Purchase Price"
                ...
                ToolTip="Please Enter Sale Price" ValidationGroup="SaveProductDetails"></asp:RequiredFieldValidator>--%>
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtSalePrice" runat="server" class="form-control" placeholder="Enter Sale Price"
                                            required></asp:TextBox></div>
                                </div>
                            </div>
                            <!--End Of First Column-->
