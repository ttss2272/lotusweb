...
<div class="panel panel-default">
    ...
    <div class="col-xs-12">
        ...
        <h3><asp:Label ID="lblPageHeading" runat="server" Text="Sale Transaction" class="control-label label label-primary"></asp:Label><h3>
        </div>
        </div>
    ...
    <!--Start First Column-->
        ...
        <div class="col-sm-8">
            <asp:TextBox ID="txtSaleTransactionNo" runat="server" class="form-control" placeholder="Sale Transacion No" readonly></asp:TextBox>
     </div> 
         </div>
         </div>
          <!--End First Column-->
    ...
    <asp:Label ID="lblReqSaleDate" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
        ...
        <div class="col-sm-8">
            <asp:TextBox ID="txtSaleDate" runat="server" class="form-control" placeholder="DD/MM/YYYY" required></asp:TextBox></div>
            <asp:CalendarExtender ID="CalendarExtenderSaleDate" runat="server" TargetControlID="txtSaleDate" Format="dd/MM/yyyy">
    ...
    <asp:Label ID="lblReqWarehosue" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            <asp:Label ID="lblWarehouse" runat="server" Text="Product Type" class="control-label">
            <asp:RequiredFieldValidator ID="ReqWarehouse" runat="server" 
                ...
                ToolTip="Please Select Warehouse" ValidationGroup="AddSaleTransaction"></asp:RequiredFieldValidator>
            </asp:Label>
    ...
    <asp:Label ID="lblReqMedical" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            <asp:Label ID="lblMedical" runat="server" Text="Product" class="control-label">
            <asp:RequiredFieldValidator ID="ReqMedical" runat="server" 
                ErrorMessage="*" Display="Dynamic" Font-Bold="True" ForeColor="Red" 
                ControlToValidate="ddlMedical" InitialValue="-1" SetFocusOnError="True" 
                ToolTip="Please Select Medical" ValidationGroup="AddSaleTransaction"></asp:RequiredFieldValidator>
            </asp:Label>
    ...
    <asp:Label ID="lblReqProduct" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            <asp:Label ID="lblProduct" runat="server" Text="Supplier" class="control-label">
            <asp:RequiredFieldValidator ID="ReqProduct" runat="server" 
                ErrorMessage="*" Display="Dynamic" Font-Bold="True" ForeColor="Red" 
                ControlToValidate="ddlProduct" InitialValue="-1" SetFocusOnError="True" 
                ToolTip="Please Select Product" ValidationGroup="AddSaleTransaction"></asp:RequiredFieldValidator>
            </asp:Label>
     ...
     <!--Start Second Column-->
      ...
      <div class="row form-group">
        ...
        <div class="col-sm-8">
            <asp:TextBox ID="txtCurrentStock" runat="server" class="form-control" placeholder="Current Stock" readonly></asp:TextBox></div>
     </div>
      </div>
    ...
    <asp:Label ID="lblReqSalePrice" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RegularExpressionValidator ID="RegSalePrice" runat="server" ErrorMessage="*"   
             ...
             ToolTip="Enter Only Numbers" ValidationGroup="AddSaleTransaction"></asp:RegularExpressionValidator>
            </asp:Label>
            
            </div>
        <div class="col-sm-8">
            <asp:TextBox ID="txtSalePrice" runat="server" class="form-control" placeholder="Purchase Price" required></asp:TextBox>
     </div> 
         </div>
         </div>
          <!--End First Column-->
    ...
    <asp:Label ID="lblReqQuantity" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
        ...
        <div class="col-sm-8">
            <asp:TextBox ID="txtQuantity" runat="server" class="form-control" placeholder="Quantity" required></asp:TextBox></div>
     </div>
      </div>
     ...
     <!--End Second Column-->
       ...
       <div class="row form-group" align="center">
        <div class="col-md-12">
            <asp:Button ID="btnAdd" runat="server" Text="Add" class="btn btn-lg btn-primary" 
                 ValidationGroup="AddSaleTransaction"/>
       ...
       <div class="col-sm-12">
        ...
        <div class="col-sm-7">
            <asp:TextBox ID="txtComment" runat="server" class="form-control" placeholder="Comment" TextMode="MultiLine"></asp:TextBox>
     </div> 
         </div>
         </div>
       </div>
    ...
    <!--Start First Column-->
        ...
        <div class="col-sm-7">
            <asp:TextBox ID="txtTotal" runat="server" class="form-control" placeholder="Total" readonly></asp:TextBox>
     </div> 
         </div>
         </div>
          <!--End First Column-->
    ...
    <asp:Label ID="lblReqDiscount" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RegularExpressionValidator ID="ReqDiscount" runat="server" ErrorMessage="*"   
             ValidationExpression="[0-9]*$" ControlToValidate="txtDiscount" 
             Display="Dynamic" Font-Bold="True" ForeColor="Red" SetFocusOnError="True" 
             ToolTip="Enter Only Numbers" ValidationGroup="SaveSaleTransaction"></asp:RegularExpressionValidator>
            </asp:Label>
            
            </div>
        <div class="col-sm-7">
            <asp:TextBox ID="txtDiscount" runat="server" class="form-control" placeholder="Discount" required></asp:TextBox>
            </div>
    ...
    <!--Start First Column-->
        ...
        <div class="col-sm-7">
            <asp:TextBox ID="txtFinalTotal" runat="server" class="form-control" placeholder="Final Total" readonly></asp:TextBox>
     </div> 
         </div>
         </div>
          <!--End First Column-->
    ...
    <asp:Label ID="lblreqAmountPaid" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RegularExpressionValidator ID="RegAmountPaid" runat="server" ErrorMessage="*"   
             ValidationExpression="[0-9]*$" ControlToValidate="txtAmountPaid" 
             Display="Dynamic" Font-Bold="True" ForeColor="Red" SetFocusOnError="True" 
             ToolTip="Enter Only Numbers" ValidationGroup="SaveSaleTransaction"></asp:RegularExpressionValidator>
            </asp:Label>
        ...
        <div class="col-sm-7">
            <asp:TextBox ID="txtAmountPaid" runat="server" class="form-control" placeholder="Amount Paid" required></asp:TextBox>
            </div>
    ...
    <!--Start First Column-->
        ...
        <div class="col-sm-7">
            <asp:TextBox ID="txtBalanceAmount" runat="server" class="form-control" placeholder="Balance Amount" readonly></asp:TextBox>
     </div> 
         </div>
         </div>
          <!--End First Column-->
