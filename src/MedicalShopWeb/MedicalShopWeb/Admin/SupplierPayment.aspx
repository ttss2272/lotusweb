<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SupplierPayment.aspx.cs" Inherits="MedicalShopWeb.Admin.SupplierPayment" %>
...
<div class="panel panel-default" align="center">
    ...
    <div class="col-xs-12">
        ...
        <h3><asp:Label ID="lblPageHeading" runat="server" Text="Supplier Payment Details" class="control-label"></asp:Label></h3></div></div>
        ...
        <asp:Label ID="PaymentDateRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            <asp:Label ID="lblPaymentDate" runat="server" Text="Payment Date" class="control-label">
             <asp:RequiredFieldValidator ID="ReqPaymentDate" runat="server" 
                ...
                ToolTip="Please Select Payment Date" ValidationGroup="SaveSupplierPaymentDetails"></asp:RequiredFieldValidator>
            </asp:Label>
             </div>
        <div class="col-sm-8">
        ...
        <div class="col-sm-4">
         <asp:Label ID="SupplierShopRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="ReqSupplier" runat="server" 
                ...
                ToolTip="Please Select Supplier" ValidationGroup="SaveSupplierPaymentDetails"></asp:RequiredFieldValidator>
            </asp:Label>
      ...
      <div class="row form-group">
        <div class="col-sm-4">
          <asp:Label ID="InvoiceNoRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            <asp:Label ID="lblPurchaseInvoiceNo" runat="server" Text="Purchase Invoice Number" class="control-label">
            <asp:RequiredFieldValidator ID="ReqInvoiceNo" runat="server" 
                ErrorMessage="*" Display="Dynamic" Font-Bold="True" ForeColor="Red" 
                ControlToValidate="ddlPurchaseInvoiceNo" InitialValue="-1" SetFocusOnError="True" 
                ToolTip="Please Select Purchase Invoice No" ValidationGroup="SaveSupplierPaymentDetails"></asp:RequiredFieldValidator>
            </asp:Label>
      ...
      <div class="row form-group">
        ...
        <asp:Label ID="lblPaidAmoReq" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            <asp:Label ID="lblPaidAmo" runat="server" Text="Paid Amount" class="control-label">
             ...
             ToolTip="Enter Only Numbers" ValidationGroup="SaveSupplierPaymentDetails"></asp:RegularExpressionValidator>
            </asp:Label>
     ...
     <div class="row form-group">
        ...
        <asp:Label ID="CommentReq" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="ReqComment" runat="server" 
                ...
                ToolTip="Please Enter Comment" ValidationGroup="SaveSupplierPaymentDetails"></asp:RequiredFieldValidator>
            </asp:Label>
     ...
     <div class="row form-group">
        <div class="col-md-12">
            <asp:Button ID="btnSave" runat="server" Text="Save" class=" btn btn-primary" 
                 ValidationGroup="SaveSupplierPaymentDetails"/>
