<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SaleReturn.aspx.cs" Inherits="MedicalShopWeb.Admin.SaleReturn" %>
...
<div class="panel panel-default">
    ...
    <div class="col-xs-12">
        ...
        <asp:Label ID="lblPageHeading" runat="server" Text="Sales Return" class="control-label label label-primary"></asp:Label></div></div>
