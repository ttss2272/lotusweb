<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="DoctorDetails.aspx.cs" Inherits="MedicalShopWeb.Admin.DoctorDetails"%>
      ...
      <div class="row form-group">
        ...
        <asp:Label ID="AddressReq" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="ReqValidatorAdd" runat="server" 
                ErrorMessage="*" Display="Dynamic" Font-Bold="True" ForeColor="Red" 
                ControlToValidate="txtAddress" InitialValue="-1" SetFocusOnError="True" 
                ToolTip="Please Enter Address" ValidationGroup="SaveDoctorDetails"></asp:RequiredFieldValidator>
            </asp:Label>
