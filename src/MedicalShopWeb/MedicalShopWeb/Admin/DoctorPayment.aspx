<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="DoctorPayment.aspx.cs" Inherits="MedicalShopWeb.Admin.DoctorPayment" %>
...
<div class="panel panel-default" align="center">
   <div class="panel-header" align="left">
    <div class="col-xs-12">
       <h3><asp:Label ID="lblPageHeading" runat="server" Text="Doctor Payment Details" class="control-label"></asp:Label></h3></div></div>
   ...
   <!--Start First Row-->
    ...
    <!--Start First Column-->
        ...
        <div class="col-sm-8">
            <asp:TextBox ID="txtReceiptNo" runat="server" class="form-control" placeholder="Receipt Number" required ReadOnly="True">
              </asp:TextBox>
      ...
      <div class="row form-group">
        <div class="col-sm-4">
         <asp:Label ID="DrNameRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="ReqDrName" runat="server" 
                ErrorMessage="*" Display="Dynamic" Font-Bold="True" ForeColor="Red" 
                ControlToValidate="ddlDrName" InitialValue="-1" SetFocusOnError="True" 
                ToolTip="Please Select Doctor Name" ValidationGroup="SaveDoctorPayment"></asp:RequiredFieldValidator>
            </asp:Label>
            </div>
        <div class="col-sm-8">
        ...
        <asp:Label ID="Daterequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            <asp:Label ID="lblDate" runat="server" Text="Paid Amount Date" class="control-label">
             <asp:RequiredFieldValidator ID="ReqDate" runat="server" 
                ...
                ToolTip="Please Select Amount Paid Date" ValidationGroup="SaveDoctorPayment"></asp:RequiredFieldValidator>
            </asp:Label>
        ...
        <div class="col-sm-4">
         <asp:Label ID="PaymentAmoRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RegularExpressionValidator ID="RegPaymentAmo" runat="server" ErrorMessage="*"   
             ValidationExpression="[0-9]*$" ControlToValidate="txtPaymentAmo" 
             Display="Dynamic" Font-Bold="True" ForeColor="Red" SetFocusOnError="True" 
             ToolTip="Enter Only Numbers" ValidationGroup="SaveDoctorPayment"></asp:RegularExpressionValidator>
            </asp:Label>

              </div>
        <div class="col-sm-8">
            <asp:TextBox ID="txtPaymentAmo" runat="server" class="form-control" placeholder="Payment Amount" MaxLength="10" required></asp:TextBox>
            </div>
      </div>
     </div>
      ...
      <div class="row form-group">
        ...
        <asp:Label ID="CommentRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="reqComment" runat="server" 
                ErrorMessage="*" Display="Dynamic" Font-Bold="True" ForeColor="Red" 
                ControlToValidate="txtComment" SetFocusOnError="True" 
      ...
      <div class="row form-group">
        <div class="col-md-12">
            <asp:Button ID="btnSave" runat="server" Text="Save" class=" btn btn-primary" 
                 ValidationGroup="SaveDoctorPayment"/>
