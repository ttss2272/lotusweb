<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="MedicalShop.aspx.cs" Inherits="MedicalShopWeb.Admin.MedicalShop" %>
...
<div class="panel panel-default" align="center">
    ...
    <div class="col-xs-12">
        ...
        <h3><asp:Label ID="lblPageHeading" runat="server" Text="Medical Shop" class="control-label"></asp:Label></h3></div></div>
   ...
   <!--Start First Row-->
    ...
    <asp:Label ID="lblRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RegularExpressionValidator ID="RegCountry" runat="server" ErrorMessage="*"   
             ValidationExpression="[a-zA-Z ]*$" ControlToValidate="txtShopName" 
             Display="Dynamic" Font-Bold="True" ForeColor="Red" SetFocusOnError="True" 
             ToolTip="Enter Only Characters" ValidationGroup="SaveMedicalShop"></asp:RegularExpressionValidator>
            </asp:Label>
            
            </div>
        <div class="col-sm-8">
            <asp:TextBox ID="txtShopName" runat="server" class="form-control" placeholder="Shop Name" required></asp:TextBox></div>
     </div> 
         </div>
          <!--End First Column-->
     <!--Start Second Column-->
    ...
    <asp:Label ID="ShopTypeRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ...
                ControlToValidate="ddlShopType" InitialValue="-1" SetFocusOnError="True" 
                ToolTip="Please Select Shop Type" ValidationGroup="SaveMedicalShop"></asp:RequiredFieldValidator>
            </asp:Label>
    ...
    <asp:Label ID="OwnerNamerequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RegularExpressionValidator ID="regOwnerName" runat="server" ErrorMessage="*"   
             ValidationExpression="[a-zA-Z ]*$" ControlToValidate="txtOwnerName" 
             Display="Dynamic" Font-Bold="True" ForeColor="Red" SetFocusOnError="True" 
             ToolTip="Enter Only Characters" ValidationGroup="SaveMedicalShop"></asp:RegularExpressionValidator>
            </asp:Label>
        ...
        <div class="col-sm-8">
            <asp:TextBox ID="txtOwnerName" runat="server" class="form-control" placeholder="Owner Name" required></asp:TextBox></div>
     </div> 
    ...
    <asp:Label ID="CountryRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="ReqCountry" runat="server" 
                ...
                ToolTip="Please Select Country" ValidationGroup="SaveMedicalShop"></asp:RequiredFieldValidator>
            </asp:Label>
    ...
    <asp:Label ID="StateRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="ReqState" runat="server" 
                ...
                ToolTip="Please Select State" ValidationGroup="SaveMedicalShop"></asp:RequiredFieldValidator>
            </asp:Label>
    ...
    <asp:Label ID="CityRequired" runat="server" Text="*" ForeColor="Red" class="control-label"></asp:Label>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ...
                ToolTip="Please Select City" ValidationGroup="SaveMedicalShop"></asp:RequiredFieldValidator>
            </asp:Label>
